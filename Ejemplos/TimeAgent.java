/*
Description:
This example shows the usage of the WakerBehaviour and TickerBehaviour 
that allow scheduling actions at given points in time.
More in details this agent executes a TickerBehaviour that prints the agent name 
every second and a WakerBehaviour that kills the agent after 10 seconds.
